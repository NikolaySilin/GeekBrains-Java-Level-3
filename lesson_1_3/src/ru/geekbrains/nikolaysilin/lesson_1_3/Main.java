...
import ru.geekbrains.nikolaysilin.lesson_1_3.exercisewithfruits.*;
...
public class Main {
    ...
    App app = new App();
        ...
        //Наполняю ящики.
        orangeBox_1.addFruit(new Orange(),10);
        orangeBox_2.addFruit(new Orange(),3);

        appleBox_1.addFruit(new Apple(),17);
        appleBox_2.addFruit(new Apple(),6);
        ...
        appleBox_1.addFruit(new Apple(),7);   //Насыпал яблок в опустевший ящик для яблок.
        orangeBox_1.addFruit(new Orange(),9); //Насыпал апельсинов в опустевший ящик для апельсинов.
